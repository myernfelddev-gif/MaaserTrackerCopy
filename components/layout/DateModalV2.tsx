...
const DateModalV2: React.FC<DateModalV2Props> = ({ isOpen, onClose, currentFilter, onConfirm }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      const trigger = document.getElementById('date-trigger-v2');
      if (
        isOpen && 
        modalRef.current && 
    ...
    >
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-black text-slate-800 tracking-tight">הגדרת טווח (V2)</h3>
        </div>
